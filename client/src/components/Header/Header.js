  ...
  return (
    <div class="container">
      <div class = "row HeaderDiv">
        <div class = "col-12">
          <img class="float-left mr-4" src={AppleseedInitiativeRingTextLogo2} alt="Appleseed Logo" />
          <h2 class = " ml-4">Electric Grid Visualization <FontAwesomeIcon icon={faBolt} /></h2>
         </div>     
